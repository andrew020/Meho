...
public class ImageCache {
	 ...
	 * 硬盘缓存大小
	 */
	private final int DISKLRU_SIZE = 200 * 1024 * 1024;
	/**
	 * 硬盘缓存文件名称
	 */
	 ...
	 * 正在进行下载任务的imageview
	 */
	private LinkedHashMap<String, LoadCompletion> callbackManager;
	/**
	 * 单例模式
	 */
	...
	public interface LoadCompletion {
        public void onComplete(Bitmap image, String imageUrl);
    }
	...
	private ImageCache(Context context) {
		...
		callbackManager = new LinkedHashMap<String, LoadCompletion>();
	}
	 ...
	 */
	public void loadImages(LoadCompletion callback, String imageUrl,
			boolean priority) {
		try {
			...
			if (bitmap == null) {
				Log.e(">>>>>>>>",">>>>为空值---"+bitmap);
				this.callbackManager.put(imageUrl, callback);
